...
- Note: BloombergGPT is enterprise-only; use alternatives like FinGPT for open-source options
...
### Questions & Issues
- GitHub Issues: https://github.com/yfedoseev/llmkit/issues
- Documentation: https://github.com/yfedoseev/llmkit/tree/main/docs
