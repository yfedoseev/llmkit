...
impl PyWord {
    /// Create a new Word.
    #[new]
    #[pyo3(signature = (word="".to_string(), start=0.0, end=0.0, confidence=0.0, speaker=None))]
    pub fn new(word: String, start: f64, end: f64, confidence: f64, speaker: Option<u32>) -> Self {
        Self {
            word,
            start,
            end,
    ...
    #[setter]
    pub fn set_word(&mut self, value: String) {
        self.word = value;
    }
    ...
    #[setter]
    pub fn set_speaker(&mut self, value: Option<u32>) {
        self.speaker = value;
    }
...
impl PyTranscribeResponse {
    /// Create a new TranscribeResponse.
    #[new]
    #[pyo3(signature = ())]
    pub fn new() -> Self {
        Self {
    ...
    #[setter]
    pub fn set_transcript(&mut self, value: String) {
    ...
    #[setter]
    pub fn set_words(&mut self, value: Vec<PyWord>) {
        self.words = value;
    }
    ...
    /// Metadata from the transcription.
    #[getter]
    ...
    #[setter]
    pub fn set_metadata(&mut self, value: Option<String>) {
        self.metadata = value;
    }
...
impl PySynthesizeResponse {
    /// Create a new SynthesizeResponse.
    #[new]
    #[pyo3(signature = ())]
    pub fn new() -> Self {
        Self {
    ...
    #[setter]
    pub fn set_audio_bytes(&mut self, value: Vec<u8>) {
        self.audio_bytes = value;
    }
