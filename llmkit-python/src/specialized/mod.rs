...
impl PyRankingResponse {
    ...
    #[getter]
    pub fn results(&self) -> Vec<PyRankedDocument> {
        self.results.clone()
    }

    #[setter]
    pub fn set_results(&mut self, value: Vec<PyRankedDocument>) {
        self.results = value;
    }
...
impl PyRerankingResponse {
    ...
    #[getter]
    pub fn results(&self) -> Vec<PyRerankedResult> {
        self.results.clone()
    }

    #[setter]
    pub fn set_results(&mut self, value: Vec<PyRerankedResult>) {
        self.results = value;
    }
...
impl PyModerationResponse {
    ...
    #[getter]
    pub fn scores(&self) -> PyModerationScores {
        self.scores.clone()
    }

    #[setter]
    pub fn set_scores(&mut self, value: PyModerationScores) {
        self.scores = value;
    }
...
impl PyClassificationResponse {
    ...
    #[getter]
    pub fn results(&self) -> Vec<PyClassificationResult> {
        self.results.clone()
    }

    #[setter]
    pub fn set_results(&mut self, value: Vec<PyClassificationResult>) {
        self.results = value;
    }
