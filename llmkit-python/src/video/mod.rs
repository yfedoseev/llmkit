...
impl PyVideoGenerationResponse {
    /// Create a new VideoGenerationResponse.
    #[new]
    #[pyo3(signature = ())]
    pub fn new() -> Self {
        Self {
    ...
    #[setter]
    pub fn set_video_bytes(&mut self, value: Option<Vec<u8>>) {
        self.video_bytes = value;
    }
    ...
    #[setter]
    pub fn set_video_url(&mut self, value: Option<String>) {
    ...
    #[setter]
    pub fn set_task_id(&mut self, value: Option<String>) {
        self.task_id = value;
    }
