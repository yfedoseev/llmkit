...
impl From<Provider> for PyProvider {
    fn from(p: Provider) -> Self {
        match p {
            ...
            Provider::NaverClova => PyProvider::NaverClova,
            ...
            Provider::SapAICore => PyProvider::SapAICore,
            ...
            Provider::GitHubModels => PyProvider::GitHubModels,
            Provider::FriendliAI => PyProvider::FriendliAI,
            Provider::Hyperbolic => PyProvider::Hyperbolic,
            Provider::LambdaLabs => PyProvider::LambdaLabs,
            ...
            // Tier 2 - Chinese Providers
            Provider::Hunyuan => PyProvider::Hunyuan,
            ...
            Provider::NttTsuzumi => PyProvider::NttTsuzumi,
            Provider::SoftBankSarashina => PyProvider::SoftBankSarashina,
            // Tier 6 - European Sovereign AI
            ...
            // Tier 9 - Audio AI Providers
            Provider::RevAI => PyProvider::RevAI,
            ...
            Provider::Recraft => PyProvider::Recraft,
            // Tier 11 - Enterprise Infrastructure
...
impl From<PyProvider> for Provider {
    fn from(p: PyProvider) -> Self {
        match p {
            ...
            PyProvider::NaverClova => Provider::NaverClova,
            ...
            PyProvider::SapAICore => Provider::SapAICore,
            ...
            PyProvider::GitHubModels => Provider::GitHubModels,
            PyProvider::FriendliAI => Provider::FriendliAI,
            PyProvider::Hyperbolic => Provider::Hyperbolic,
            PyProvider::LambdaLabs => Provider::LambdaLabs,
            ...
            // Tier 2 - Chinese Providers
            PyProvider::Hunyuan => Provider::Hunyuan,
            ...
            PyProvider::NttTsuzumi => Provider::NttTsuzumi,
            PyProvider::SoftBankSarashina => Provider::SoftBankSarashina,
            // Tier 6 - European Sovereign AI
            ...
            // Tier 9 - Audio AI Providers
            PyProvider::RevAI => Provider::RevAI,
            ...
            PyProvider::Recraft => Provider::Recraft,
            // Tier 11 - Enterprise Infrastructure
