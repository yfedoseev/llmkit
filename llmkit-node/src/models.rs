...
impl From<Provider> for JsProvider {
    fn from(p: Provider) -> Self {
        match p {
            ...
            Provider::NaverClova => JsProvider::NaverClova,
            ...
            Provider::SapAICore => JsProvider::SapAICore,
            ...
            Provider::GitHubModels => JsProvider::GitHubModels,
            Provider::FriendliAI => JsProvider::FriendliAI,
            Provider::Hyperbolic => JsProvider::Hyperbolic,
            Provider::LambdaLabs => JsProvider::LambdaLabs,
            ...
            Provider::Hunyuan => JsProvider::Hunyuan,
            ...
            Provider::NttTsuzumi => JsProvider::NttTsuzumi,
            Provider::SoftBankSarashina => JsProvider::SoftBankSarashina,
            ...
            Provider::RevAI => JsProvider::RevAI,
            ...
            Provider::Recraft => JsProvider::Recraft,
...
impl From<JsProvider> for Provider {
    fn from(p: JsProvider) -> Self {
        match p {
            ...
            JsProvider::NaverClova => Provider::NaverClova,
            ...
            JsProvider::SapAICore => Provider::SapAICore,
            ...
            JsProvider::GitHubModels => Provider::GitHubModels,
            JsProvider::FriendliAI => Provider::FriendliAI,
            JsProvider::Hyperbolic => Provider::Hyperbolic,
            JsProvider::LambdaLabs => Provider::LambdaLabs,
            ...
            JsProvider::Hunyuan => Provider::Hunyuan,
            ...
            JsProvider::NttTsuzumi => Provider::NttTsuzumi,
            JsProvider::SoftBankSarashina => Provider::SoftBankSarashina,
            ...
            JsProvider::RevAI => Provider::RevAI,
            ...
            JsProvider::Recraft => Provider::Recraft,
